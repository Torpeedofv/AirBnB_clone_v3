...
@app_views.route('/api/v1/cities/<city_id>/places', strict_slashes=False, methods=['GET', 'POST'])
...
@app_views.route('/api/v1/places/<place_id>', strict_slashes=False, methods=['GET', 'DELETE', 'PUT'])
def methods(place_id):
